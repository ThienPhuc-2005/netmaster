...
describe('bộ nội dung', () => {
  ...
  it('accept gõ tay nhận đủ các cách viết mà người thật hay gõ', () => {
    ...
    const CASES: ReadonlyArray<readonly [string, string]> = [
      ...
      ['m7-mt-7', 'NAT kép'],
      ['m7-mt-11', 'mở cổng'],
      ['m7-mt-14', 'đặt trước địa chỉ theo MAC cho máy in'],
      ['m7-mt-15', 'carrier grade nat'],
      ['m8-mt-2', '6 GHz'],
      ['m8-mt-3', 'WPA3'],
      ['m8-mt-4', 'linklocal'],
      ...
      ['m17-mt-14', 'nó tự sinh một MAC ngẫu nhiên cho mạng đó'],
    ...
    const CA_XAU: ReadonlyArray<readonly [string, string]> = [
      ...
      ['m17-b4b-ret-1', 'vì switch tự khai mac cho từng cổng nên hai máy có thể trùng tên'],
      ['m17-mt-14', 'nó xin router đổi mac cho nó'],
