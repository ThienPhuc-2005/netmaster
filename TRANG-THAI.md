...
Việc kế tiếp là của CHỦ DỰ ÁN: ra lệnh commit khối 21.59. **Kho ý tưởng SẠCH — không còn ý nào chờ duyệt.** **Kho ý tưởng còn 2 ý chờ duyệt (N3, N5).** **Kho ý tưởng còn 4 ý chờ duyệt (N1, N2, N3, N5).** **Kho ý tưởng còn 5 ý chờ duyệt (mục N).** **Cả 17 phát
...
**KHỐI MỚI NHẤT — 21.59 (08-12), đang ở working tree chờ lệnh commit:**
...
- **O1 — nút chữ 16px, mà cái bên cạnh nó là nút XOÁ.** "Mở lại bài",
  ...
  đáng sợ không phải khó bấm: ở trang Hồ sơ hai nút ấy nằm cạnh nhau
  trong một dòng, một cái mở bài một cái xoá dòng — bấm trượt trên điện
  thoại là mất dữ liệu. Chữa bằng một lớp dùng chung, nới vùng chạm mà
  không xô lệch một pixel bố cục nào.
- **O2 — bảng VLSM: cuộn sang phải là mất tên phòng.** Bảng rộng 480px
  trong khung 343px, nên lúc gõ ô Prefix thì cột "Phòng ban 1" trôi khỏi
  màn. Đang điền số cho một phòng mà không thấy phòng nào, trong khi cả
  bài VLSM là khớp cỡ với đúng phòng. Cột đầu giờ dính lại.
- **O3 — trên điện thoại chỉ cấu hình thiết bị được bằng cách chạm vào
  sơ đồ rộng hơn màn hình.** Bảng Cấu hình chỉ nói "chọn trên sơ đồ" rồi
  để trống. Nặng hơn cả lỗi: **sổ kỹ thuật đang tự trấn an** rằng "mọi
  thao tác vẫn làm trọn được ở bảng cấu hình bên dưới" — câu đó chỉ đúng
  SAU khi đã chọn được thiết bị. Giờ bảng tự liệt kê thiết bị.
- 1849 test xanh (+4), typecheck sạch, build qua. Đo lại trên điện thoại
  sau khi sửa: không còn nút nào dưới 24px ở trang Hồ sơ lẫn trang Học
  ("Mở lại bài" 54×28, "Xem lại" 56×28); cuộn hết bảng VLSM sang phải thì
  "Phòng ban 1" vẫn dính ở mép trái; bảng Cấu hình liệt kê đủ 4 thiết bị,
  nút cao 30px. Seed đã xóa.

**KHỐI TRƯỚC — 21.58 (08-12), đã commit `2375042`:**
**Ý N5 — phiên "luyện thứ hay quên" bắn trúng đích. KHO Ý TƯỞNG SẠCH.**
- **Đo trước khi làm, và con số đáng ghi lại**: 108 bài / 202 câu tập, tức
  trung bình 1,87 câu mỗi bài. Chỉ **43 bài (87 câu)** có ≥2 câu VÀ ≥2 khái
  niệm — chỉ ở đó việc lọc mới đổi được gì. Nói cách khác ý này ăn thua ở
  khoảng 40% số bài, mỗi lần đổi chừng một câu.
- **Gắn thẻ khái niệm cho 77 câu**, đọc từng câu một. 9 câu còn lại CỐ Ý
  để trống vì chúng bắc cầu hai khái niệm ("GROUP để cấp ___, OU để xếp
  chỗ") — gán bừa một bên là nói sai về chính câu đó. Câu không khai thì
  phiên lùi về lấy cả bài như cũ.
- **Cổng chất lượng chặn thẻ sai**: khai thì phải khai đúng khái niệm
  CHÍNH BÀI ĐÓ dạy. Thẻ trỏ ra ngoài bài còn tệ hơn không khai — nó lôi
  câu ra cho một khái niệm nó không hề luyện.
- 1845 test xanh (+5), typecheck sạch, build qua, bản đọc duyệt render lại
  được. Kiểm browser thật: gieo thẻ quên `m8-wpa2` → phiên ra ĐÚNG 1 câu
  về WPA2 (trước đây ra cả 2 câu của bài); đổi sang `m8-wpa3` → ra đúng
  câu WPA3. Seed đã xóa.

**KHỐI TRƯỚC — 21.57 (08-12), đã commit `79237d6`:**
